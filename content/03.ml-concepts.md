...
Those developing deep learning models should select datasets relevant to the problem at hand; non-salient data can hamper performance or lead to spurious conclusions.
...
The model may be capturing signals unrelated to genetic mechanisms underlying the phenotype.
